...
def output_report(district_1, district_2, dist_1_ppe, dist_2_ppe, comment_1, comment_2, report_name, dir):
    ...
    page_1(pdf, major_bar, comment_1, comment_2, dist_1_ppe, dist_2_ppe, pie_1, pie_2)
    pdf.add_page()
...
def page_1(pdf, major_bar, comment_1, comment_2, dist_1_ppe, dist_2_ppe, pie_1, pie_2):
